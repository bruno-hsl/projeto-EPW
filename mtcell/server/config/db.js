...
const sequelize = new Sequelize('mtcell', 'root', 'root', {
  // 'mtcell' é o nome do banco de dados que estamos usando. É onde nossas tabelas e dados serão armazenados
  // 'root' é o nome de usuário do banco de dados, que normalmente é o nome padrão para a instalação local do MySQL
  // 'root' é a senha para acessar o banco de dados. Essa senha deve ser configurada no MySQL para o usuário 'root'.
